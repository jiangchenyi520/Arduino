...
byte Usuario1[4]= {0xB2, 0x18, 0x54, 0x13} ;    // UID de tarjeta leido en programa 1
byte Usuario2[4]= {0x16 , 0x33, 0x63, 0xD3} ;    // UID de llavero leido en programa 1

void setup() {
  M5.begin(); // inicializa comunicacion por monitor serie a 9600 bps
      ...
      if (mfrc522.uid.uidByte[i] < 0x10){   // si el byte leido es menor a 0x10
        Serial.print(" 0");       // imprime espacio en blanco y numero cero
          ...
          if(comparaUID(LecturaUID, Usuario1))    // llama a funcion comparaUID con Usuario1
            M5.Lcd.print("Bienvenido Chenyi Jiang \n");// si retorna verdadero muestra texto bienvenida
          else if(comparaUID(LecturaUID, Usuario2)) // llama a funcion comparaUID con Usuario2
            M5.Lcd.print("Bienvenido Ekaterina \n"); // si retorna verdadero muestra texto bienvenida
